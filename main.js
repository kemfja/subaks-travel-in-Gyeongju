                ...
                onSnapshot(mapDocRef, async (docSnap) => {
                    ...
                    if (data) {
                        ...
                        if (data.trips && data.trips.length > 0) {
                            trips = data.trips;
                        } else if (data.itinerary && data.itinerary.totalDays > 0) {
                            let migratedDays = data.itinerary.days || [];
